...
export default function EmbeddedSitePreview({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200/70 bg-slate-50">
      ...
      <div className="h-[520px] w-full lg:h-[720px]">
          ...
          <div id="interactive-map" className="luchnihaj-map-wrapper h-full w-full">
            ...
            >
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "5" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="5"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "6" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="6"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "7" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="7"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "8" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="8"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "9" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="9"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "10" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="10"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "11" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="11"
              ...
              <g className="lh-zone-group">
                <polygon
                  className={`lh-zone cursor-pointer ${
                    selectedHouseId === "12" ? "opacity-100" : "hover:opacity-80"
                  }`}
                  data-house-id="12"
