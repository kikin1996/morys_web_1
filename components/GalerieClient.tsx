...
const IMAGES = [
  ...
  { id: 9,  label: "Interiér – B1", category: "interior", src: "/images/vizualizace-interieru/b%20(1).webp" },
  { id: 10, label: "Interiér – B2", category: "interior", src: "/images/vizualizace-interieru/b%20(2).webp" },
  { id: 11, label: "Interiér – B3", category: "interior", src: "/images/vizualizace-interieru/b%20(3).webp" },
  { id: 12, label: "Interiér – B4", category: "interior", src: "/images/vizualizace-interieru/b%20(4).webp" },
  { id: 13, label: "Interiér – B5", category: "interior", src: "/images/vizualizace-interieru/b%20(5).webp" },
  { id: 14, label: "Interiér – B6", category: "interior", src: "/images/vizualizace-interieru/b%20(6).webp" },
  { id: 15, label: "Interiér – C1", category: "interior", src: "/images/vizualizace-interieru/c%20(1).webp" },
  { id: 16, label: "Interiér – C2", category: "interior", src: "/images/vizualizace-interieru/c%20(2).webp" },
  { id: 17, label: "Interiér – C3", category: "interior", src: "/images/vizualizace-interieru/c%20(3).webp" },
  { id: 18, label: "Interiér – C4", category: "interior", src: "/images/vizualizace-interieru/c%20(4).webp" },
  { id: 19, label: "Interiér – C5", category: "interior", src: "/images/vizualizace-interieru/c%20(5).webp" },
  { id: 20, label: "Interiér – C6", category: "interior", src: "/images/vizualizace-interieru/c%20(6).webp" },
  { id: 21, label: "Interiér – koupelna D1", category: "interior", src: "/images/vizualizace-interieru/d%20(1).webp" },
  { id: 22, label: "Interiér – koupelna D2", category: "interior", src: "/images/vizualizace-interieru/d%20(2).webp" },
  { id: 23, label: "Interiér – koupelna D3", category: "interior", src: "/images/vizualizace-interieru/d%20(3).webp" },
  { id: 24, label: "Interiér – koupelna D4", category: "interior", src: "/images/vizualizace-interieru/d%20(4).webp" },
];
            ...
            <div className="grid gap-8 md:grid-cols-2 md:items-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm leading-relaxed text-neutral-600 sm:text-base">
                  Prohlédněte si fotografie exteriéru a vizualizace interiéru projektu Na Blatnici ve Frýdku-Místku.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            {lightboxIndex !== null && lightboxIndex < filteredImages.length - 1 && (
              <button
                ...
                onClick={() => setLightboxIndex((prev) => (prev !== null && prev < filteredImages.length - 1 ? prev + 1 : prev))}
              >
                ›
              </button>
            )}
            ...
            />
            <p className="mt-3 text-center text-sm text-neutral-100">{currentImage.label}</p>
          </div>
        </div>
      )}
    </>
